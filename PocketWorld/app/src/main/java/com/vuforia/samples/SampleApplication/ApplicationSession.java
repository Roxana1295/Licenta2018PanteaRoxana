...
public class ApplicationSession implements UpdateCallbackInterface
{
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mLifecycleLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "AZOLMp//////AAAAGfNVhNnYh0K1nZqwOrUpXDpazXkg/" +
                                                                    "Oji7E8+OHbmv5ZhyN3L2kmEtRkBW/bJFHqwloE29e4BNM/" +
                                                                    "Hmlz7PAmhrQQJvW1r/8q+gnyXQ/WOsh5pURpalT0LJoGWn" +
                                                                    "YRFadpRmdYRyCdlfTC3w8nU99A46b3KSRP0jGM6vuual0l" +
                                                                    "q2fSqcYbPc10nAu0em/OU/fI68QEhac07ZaK/gdOR9sYdD" +
                                                                    "VWSsKmF5d1CG8bzkRpFf1EYbTEk1izd6e7U3Ifee7EgAjdU" +
                                                                    "mhKVSWbGtxEX6dMPX59AjxtoVDxbjcgeTkNl6WRJ7UuxmZ3" +
                                                                    "v9VEwQ0khtLVel6FCpjSIcs9rohYaSQ4NnrIa8D0yoAHXFp" +
                                                                    "esyQjJDuHd");
